...
<body <?php body_class(); ?>>
    ...
    <div class="header-container">
        ...
        <div id="brand">
            <h1 class="site-title"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><?php bloginfo( 'name' ); ?></a> <span class="sam-sub"><?php echo get_bloginfo( 'description' ); ?></span></h1>
        </div>
